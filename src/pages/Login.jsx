      ...
      <div className="w-full bg-gray-300 bg-opacity-25 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#" autoComplete="off">
                  <div>
                      <label for="email" className="block mb-2 text-sm font-medium uppercase text-gray-200 dark:text-white">Your email</label>
                  ...
                  <div>
                      <label for="password" className="block mb-2 text-sm font-medium text-gray-200 dark:text-white uppercase">Password</label>
