  ...
  return (
    <div>
      <div className="relative">
        ...
        />
        <div className="absolute top-1/3 text-white left-4">
          <p className="">FEATURE</p>
          <p>Behind the scenes: Designing Hogwarts castle</p>
        </div>
      </div>

      <article className="mb-5 w-3/5 mx-auto">
        <p className="text-xl leading-6 font-semibold tracking-wide">
          <span className="text-5xl text-[#AA8855]">V</span>isualising a location as iconic as Hogwarts for a major
          motion picture is no easy task. It takes research, imagination – and
          sometimes a bit of cheating.
        </p>
      <img
      ...
      <article className="m-4 mb-5">
        ...
        <p className="font-semibold leading-6">
          <a href="https://www.wizardingworld.com/" target="_blank" className="underline">
      ...
      />
      <article className="m-4 mb-5">
        <p className="font-semibold mx-auto w-3/5">
          ...
          <br /><br />
          Although designed to look and feel like
          an enduring institution, Hogwarts has evolved to match the needs of
          the story over the course of eight films.
        </p>
      </article>
      <img src="https://images.ctfassets.net/usf1vwtuqyxm/2phT56DSucuUqU6Icm6mCe/79c7ad7bca59b0626fe4e2e80d188ca5/HogwartsCastle_WB_F4_HogwartsThroughTheTrees_Illust_100615_Land.jpg?w=768&q=70&fm=webp" alt="" />
      <article className="m-4 mb-5">
        <p className="font-semibold">‘The way to go would have been able to read right through the seven books when we started,’ Craig laughs. ‘But I think some of these changes and additions have added a level of interest to the films. We’ve moved things around, let things expand, had them develop, or made them disappear altogether.’</p>
      </article>
      <section>

      <img src="https://images.ctfassets.net/usf1vwtuqyxm/7Fm5Q4LRJYOE0aySoOE8gW/e315a5852c9de10da9ec7d71eeab07fa/HogwartsCastle_WB_F5_HogwartsAndHogsmeadeStation_Illust_100615_Port.jpg?w=768&q=70&fm=webp" alt="" />
      <img src="https://images.ctfassets.net/usf1vwtuqyxm/4j6x7iMI88aicYasciiMsm/ebe15036f6c78846c3e8b2fde3ea5795/HogwartsCastle_WB_F5_HogwartsCastleIllustration_Illust_080615_Land.jpg?w=768&q=70&fm=webp" alt="" />
      <img src="https://images.ctfassets.net/usf1vwtuqyxm/1GfgwuXgDqAu8EKKGGOCSw/48059019f591473ef428d3a60ebd3952/Harry-Potter-Page-to-Screen-Cover.jpg?w=768&q=70&fm=webp" alt="" />
      </section>
    </div>
  );
};
